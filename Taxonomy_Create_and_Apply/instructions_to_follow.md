...
`raw_input.csv` = `root/Taxonomy_Create_and_Apply/raw_input.csv`
`Data_Sampling.md` = `root/Taxonomy_Create_and_Apply/Data_Sampling.md`
`Taxonomy_Create.md` = `root/Taxonomy_Create_and_Apply/Taxonomy_Create.md`
`Taxonomy_Review.md` = `root/Taxonomy_Create_and_Apply/Taxonomy_Review.md`
`Taxonomy_Apply.md` = `root/Taxonomy_Create_and_Apply/Taxonomy_Apply.md`
